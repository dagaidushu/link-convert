...
export const translations = {
  'zh-CN': {
    ...
    allowInsecureTip: '开启后仅对转换配置强制关闭证书验证；通用 Base64 原样订阅不会被修改。',
    UASettings: '自定义UserAgent',
    UAtip: '默认值curl/7.74.0',
    subscriptionLinks: '订阅链接',
    xrayLink: '通用节点订阅 (Base64)',
    singboxLink: 'SingBox 配置 (JSON)',
    clashLink: 'Clash 链接',
    surgeLink: 'Surge 链接',
    rawSubscription: '原样订阅',
    convertedConfig: '转换配置',
    conversionReport: '转换报告',
    reportSuccess: '成功',
    reportWarnings: '警告',
    reportSkipped: '跳过',
    reportAllCompatible: '全部节点可转换',
    reportShowDetails: '查看详情',
    reportHideDetails: '收起详情',
    insecureOverrideWarning: '已对转换配置关闭证书验证，请仅在确认风险后使用。',
    parseIssues: '输入解析问题',
    copied: '已复制！',
    shortening: '正在生成短链接...',
  ...
  'en-US': {
    ...
    allowInsecureTip: 'When enabled, certificate verification is disabled only in converted configs. The raw Base64 subscription is unchanged.',
    UASettings: 'Custom UserAgent',
    UAtip: 'By default it will use curl/7.74.0',
    subscriptionLinks: 'Subscription Links',
    xrayLink: 'Generic Subscription (Base64)',
    singboxLink: 'SingBox Configuration (JSON)',
    clashLink: 'Clash Link',
    surgeLink: 'Surge Link',
    rawSubscription: 'Raw subscription',
    convertedConfig: 'Converted config',
    conversionReport: 'Conversion report',
    reportSuccess: 'Success',
    reportWarnings: 'Warnings',
    reportSkipped: 'Skipped',
    reportAllCompatible: 'All nodes are compatible',
    reportShowDetails: 'Show details',
    reportHideDetails: 'Hide details',
    insecureOverrideWarning: 'Certificate verification is disabled in converted configs. Use only if you understand the risk.',
    parseIssues: 'Input parsing issues',
    copied: 'Copied!',
  ...
  'fa': {
    ...
    allowInsecure: 'اجازه گواهی ناامن',
    allowInsecureTip: 'با فعال‌سازی، اعتبارسنجی گواهی فقط در پیکربندی‌های تبدیل‌شده غیرفعال می‌شود و اشتراک خام Base64 تغییر نمی‌کند.',
    UASettings: 'UserAgent سفارشی',
    UAtip: 'به طور پیش‌فرض از curl/7.74.0 استفاده می‌کند',
    subscriptionLinks: 'لینک‌های اشتراک',
    xrayLink: 'اشتراک عمومی (Base64)',
    singboxLink: 'پیکربندی SingBox (JSON)',
    clashLink: 'لینک Clash',
    surgeLink: 'لینک Surge',
    rawSubscription: 'اشتراک خام',
    convertedConfig: 'پیکربندی تبدیل‌شده',
    conversionReport: 'گزارش تبدیل',
    reportSuccess: 'موفق',
    reportWarnings: 'هشدارها',
    reportSkipped: 'ردشده',
    reportAllCompatible: 'همه گره‌ها سازگارند',
    reportShowDetails: 'نمایش جزئیات',
    reportHideDetails: 'بستن جزئیات',
    insecureOverrideWarning: 'اعتبارسنجی گواهی در پیکربندی‌های تبدیل‌شده غیرفعال است. فقط با آگاهی از خطر استفاده کنید.',
    parseIssues: 'مشکلات تجزیه ورودی',
    copied: 'کپی شد!',
  ...
  'ru': {
    ...
    allowInsecure: 'Разрешить небезопасные сертификаты',
    allowInsecureTip: 'При включении проверка сертификатов отключается только в преобразованных конфигурациях. Исходная Base64-подписка не изменяется.',
    UASettings: 'Пользовательский UserAgent',
    UAtip: 'По умолчанию используется curl/7.74.0',
    subscriptionLinks: 'Ссылки подписки',
    xrayLink: 'Универсальная подписка (Base64)',
    singboxLink: 'Конфигурация SingBox (JSON)',
    clashLink: 'Ссылка Clash',
    surgeLink: 'Ссылка Surge',
    rawSubscription: 'Исходная подписка',
    convertedConfig: 'Преобразованная конфигурация',
    conversionReport: 'Отчет о преобразовании',
    reportSuccess: 'Успешно',
    reportWarnings: 'Предупреждения',
    reportSkipped: 'Пропущено',
    reportAllCompatible: 'Все узлы совместимы',
    reportShowDetails: 'Показать детали',
    reportHideDetails: 'Скрыть детали',
    insecureOverrideWarning: 'Проверка сертификатов отключена в преобразованных конфигурациях. Используйте только если понимаете риск.',
    parseIssues: 'Ошибки разбора ввода',
    copied: 'Скопировано!',
